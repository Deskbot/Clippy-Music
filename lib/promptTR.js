//I've changes this by getting rid of the process.stdin handler for SIGINT because it stops my stuff from working
//I then changed some other stuff in order to cut down the size and dependencies
...
prompt.start = function (options) {
  ...
  if (process.platform !== 'win32') {
    ...
    //process.on('SIGINT', function () { //this is what's removed
    //  stdout.write('\n');
    //  process.exit(1);
    //});
  }
