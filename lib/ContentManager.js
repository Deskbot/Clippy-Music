...
class ContentManager {
	...
	add(info) { console.log("contentmanger: add");
		...
		return new Promise(function(resolve, reject) {
			if (!info.musicIsLocal) {
				...
				that.downloadYtInfo(info.ytId).then(function(data) {
	...
	downloadYtInfo(urlOrId) { console.log("contentmanger: downloadYtInfo");
		return new Promise(function(resolve, reject) {
			let infoProc = cp.spawn('./bin/youtube-dl', ['--no-playlist', '--get-title', '--get-duration', urlOrId]);
			let rawData = '';
	...
	downloadYtVid(urlOrId, destination) { console.log("contentmanger: downloadYtVid");
		return new Promise(function(resolve, reject) {
			const dlProc = cp.spawn('./bin/youtube-dl', ['--no-playlist', urlOrId, '-o', destination]);
