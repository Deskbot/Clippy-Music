...
class ContentManager {
	...
	startMusic(path, duration, startTime, endTime) { console.log("contentmanger: startMusic");
		return this.runningMusicProc = cp.spawn('timeout', [duration + 's', 'mpv', '-vo', 'xv', '-fs', '-quiet', '--af=drc=2:0.25', path, '--start-time', startTime, '--end-time', endTime]); //settings match those by music.get
	}
